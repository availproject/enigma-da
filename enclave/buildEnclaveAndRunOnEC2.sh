...
#nitro-cli run-enclave --cpu-count 2 --memory 5240 --enclave-cid 16 --eif-path enclaveserver.eif --debug-mode --attach-console
nitro-cli run-enclave --cpu-count 2 --memory 5240 --enclave-cid 16 --eif-path enclaveserver.eif 
